...
import componentStrings = require("ojL10n!./resources/nls/codeview-component-strings");
...
features:
  ...
  rawJson = {
    ...
    features: ["authentication", "logging", "notifications"]
  };

  formattedJson = ko.observable<string>();
    ...
    constructor(context: Composite.ViewModelContext<Composite.PropertiesType>) {
        ...
        //Example observable
        this.messageText = ko.observable("Hello from codeview-component");
        this.properties = context.properties;
        this.res = componentStrings["codeview-component"];

        const pretty = JSON.stringify(this.rawJson, null, 2);
    this.formattedJson(pretty);
