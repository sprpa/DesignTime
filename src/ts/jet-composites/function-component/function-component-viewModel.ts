...
import componentStrings = require("ojL10n!./resources/nls/function-component-strings");
...
export default class ViewModel implements Composite.ViewModel<Composite.PropertiesType> {
    ...
    constructor(context: Composite.ViewModelContext<Composite.PropertiesType>) {
        ...
        //Example observable
        this.messageText = ko.observable("Hello from function-component");
        this.properties = context.properties;
        this.res = componentStrings["function-component"];
