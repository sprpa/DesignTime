...
import componentStrings = require("ojL10n!./resources/nls/finetune-component-strings");
...
export default class ViewModel implements Composite.ViewModel<Composite.PropertiesType> {
    ...
    constructor(context: Composite.ViewModelContext<Composite.PropertiesType>) {
        ...
        //Example observable
        this.messageText = ko.observable("Hello from finetune-component");
        this.properties = context.properties;
        this.res = componentStrings["finetune-component"];
